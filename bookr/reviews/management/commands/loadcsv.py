...
from reviews.models import Publisher, Contributor, Book, BookContributor, Reviews
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for data_dict in models.get('Review', []):
            ...
            review, created = Reviews.objects.get_or_create(content=data_dict['review_content'],
                                                           book=book,
                                                           creator=creator,
                                                           defaults={
